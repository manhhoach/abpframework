...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 5bd9837a-4917-4744-b495-f0cfb62e34c5
```

> `5bd9837a-4917-4744-b495-f0cfb62e34c5` is the password of the certificate, you can change it to any password you want.
